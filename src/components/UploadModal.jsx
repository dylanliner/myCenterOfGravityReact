...
function Example({ onComplete, handleClose }) {
  ...
  }, [cityCoord, excludedCityCoord, radius, excludedCityRadius, onComplete, handleClose]);


  function checkIfWithinDistance(testLocation, centerPoint, distanceToCenter) {
    const ky = 40000 / 360;
    const kx = Math.cos(Math.PI * centerPoint.lat / 180.0) * ky;
    const dx = Math.abs(centerPoint.lng - testLocation.longitudeE7 / 10000000) * kx;
    const dy = Math.abs(centerPoint.lat - testLocation.latitudeE7 / 10000000) * ky;
