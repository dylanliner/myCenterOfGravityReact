...
function Example() {
    ...
    const onDrop = React.useCallback(acceptedFiles => {
        ...
        os.node( 'locations.*', function ( location ) {
            console.log( 'latitude:', location.latitudeE7);
            latitudeSum =latitudeSum+location.latitudeE7;
            console.log( 'longitude', location.longitudeE7);
            longitudeSum = longitudeSum+ location.longitudeE7
            ++positionCount;
        }).done(function (){
            console.log('position count' + positionCount)
            const centerOfGravityLatitude=latitudeSum/positionCount;
            const centerOfGravityLongitude=longitudeSum/positionCount;
